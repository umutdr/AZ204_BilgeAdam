exports.creds = {
  // Required
  identityMetadata:
    'https://login.microsoftonline.com/c0fbd282-68ef-4c22-8ce3-88e3e5d9c688/v2.0/.well-known/openid-configuration',
  ...
  clientID: 'daa34687-3333-479b-97de-b5b50f46d7c3',

  // Required if `responseType` is 'code', 'id_token code' or 'code id_token'.
  // If app key contains '\', replace it with '\\'.
  clientSecret: '1ICc2S~mA1P.9E51lN46nT1-3f1Qf-IG~1',
